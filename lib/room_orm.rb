...
# 		self.new.tap do |room| # tap makes sure it returns the whole instance. Like in the method above where the last line is room b/c you want that instance returned back to you
# 			room.id = row[0]
# 			room.title = row[1]
